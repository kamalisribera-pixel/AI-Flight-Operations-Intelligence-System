...
st.markdown("<div class='hero'><div class='eyebrow'>Agent workspace / fault isolation</div><h1>Failure analysis</h1><p>Describe the observed condition and let the engineering agent assemble causes, impact, risk, and next actions.</p></div>", unsafe_allow_html=True)
