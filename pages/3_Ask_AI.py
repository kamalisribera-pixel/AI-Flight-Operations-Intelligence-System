...
st.markdown("<div class='hero compact-hero'><div class='eyebrow'>Operational copilot / grounded retrieval</div><h1>Ask AI</h1><p>Ask a question across your indexed aerospace manuals and receive a cited engineering response.</p></div>", unsafe_allow_html=True)
